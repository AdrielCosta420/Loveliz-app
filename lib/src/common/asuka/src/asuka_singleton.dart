// ignore_for_file: constant_identifier_names, prefer_single_quotes, require_trailing_commas, prefer_final_locals, use_super_parameters
...
class _Asuka {
  ...
  Future<material.PersistentBottomSheetController> showBottomSheet<T>(
      Widget Function(BuildContext) builder,
      {Color? backgroundColor,
      double? elevation,
      ShapeBorder? shape,
      Clip? clipBehavior,
      bool callback = false}) async {
    _checkBuilderIsInMaterialApp();
    if (callback) _checkAndInvokeCallback();
